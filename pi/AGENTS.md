...
- **Type safety**: No `any`, no non-null assertion operator (`!`), no type assertions (`as Type`) in TypeScript code
- **Consistent coding style**: Follow a consistent coding style, including naming conventions
...
- **Readonly mode**: When using readonly mode, you are only reading, planning, answering, or asking questions.
